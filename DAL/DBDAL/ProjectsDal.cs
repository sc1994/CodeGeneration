...
namespace DAL
{
    public partial class ProjectsDal
    {
        ...
        public int Add(Projects model)
        {
             ...
             strSql.Append("ProjectID,TaskID,ProjectSubType,ProjectName,SurveyReportID,SurveyReportName,Areas,Floors,High,Investment,Sffz,PartFloors,UndergroundFloors,AtticFloors,PartHigh,CraneTonnage,ProjectLevel,AseismaticType,Structure,AseismaticLevel,WallMaterials,FieldType,Foundation,FireproofLevel,UnderFireproofLevel,RoofWaterproofLevel,UnderWaterproofLevel,DefendLevel,PlantSpan,AccountReceivable,Demo,FormulaContent,ChargeAmount,ISPreferentia,FormulaName,MinChargeAmount,DrawingNum,Lng,Lat");
